(function() {
  ...
  function runBlock($rootScope, $window, authorization, amMoment) {
    ...
    $window.i18n = {
      ...
      'Authenticating': 'Identiteit controleren',
      'Validating your credentials with our server..': 'Je gegevens controleren bij de server..',
      ...
      'Use the link in the verification mail we sent to reset your password.': 'Gebruik je link in het mailtje om je wachtwoord te resetten.',
